...
#define INPUTS_PINS \
	{               \
		0           \
	} /** Define the pin of the input with following format: {x, y, z} */
#define INPUTS_MODES \
	{                \
		U            \
	}                                  /** Define the init mode of the input pin (N, U or A) */
...
#define OUTPUTS_PINS \
	{                \
		12           \
	} /** Define the pin of the output with following format: {x, y, z} */
// Aliases
...
#define INPUTS_PINS \
	{               \
		0, 5        \
	} /* D3, D1 */ /** Define the pin of the input with following format: {x, y, z} */
#define INPUTS_MODES \
	{                \
		U, U         \
	}                                  /** Define the init mode of the input pin (N, U or A) */
...
#define OUTPUTS_PINS \
	{                \
		12           \
	} /* D6 */ /** Define the pin of the output with following format: {x, y, z} */
// Aliases
#define OUTPUTS_BUZZER     0 /** Output for the buzzer is the first output declared above */
